...
with open('Main/logs/traffic_with_ddos_and_peak(2).json', 'r') as f:
...
kmeans = KMeans(n_clusters=3, n_init=10)  # 3 clusters: benign, hike, downward; 10 initialisations to choose the best from
...
#     cluster_label = kmeans.predict(test_feature_df)
